  ...
  return (
    <div className="bg-slate-900 ">
      <footer className="footer p-10 bg-transparent text-base-content m-auto container">
        <aside className="items-center grid-flow-col max-w-52">
          <p>{t("copyright")}</p>
        </aside>

        <nav className="max-w-[45%]">
        ...
        <div>
          ...
          <form>
            <h6 className="footer-title zero:max-w-28  sm:max-w-48 lg:max-w-96">
              {t("newsletter")}
            </h6>
            <fieldset className="form-control w-80">
              ...
              <div className="join zero:max-w-28 sm:max-w-48 lg:max-w-96">
                <input
                  type="text"
                  placeholder="username@site.com"
                  className="input input-bordered join-item zero:max-w-28  sm:max-w-48 lg:max-w-96"
                />
